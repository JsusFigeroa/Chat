...
/// error en otro caso.
pub(super) async fn retry_identify<T: Unpin + AsyncRead>(mut reader: &mut BufReader<T>) -> Result<String, ()> {
...
pub(super) async fn generate_map_users(users: Arc<DashMap<String, Arc<User>>>) -> HashMap<String, State> {
